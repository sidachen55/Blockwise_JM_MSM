...
#####################
#### fitting Joint competing risk model (block 1)
...
L_data_cr<-L_data
L_data_cr$Tstop<- rep(unique(data_cr$Tstop),as.vector(table(L_data_cr$ID)))
...
save(x, file=paste0("cr_b1_",task_id,".rdata"))
