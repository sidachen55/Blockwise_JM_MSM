...
# data preparation 
################################################################################
cr_id <- data_mstate$id[which(data_mstate$transition==9)]
data_UJ <- data_mstate[data_mstate$transition==9,]
...
data_UJ$transition<-replace(data_UJ$transition,data_UJ$transition==c(9),c(1))
...
save(x, file=paste0("JM-ST-H-9_",task_id,".rdata"))
